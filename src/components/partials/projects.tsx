...
const projects = [
	{
		...
		title: 'CareWise',
		description:
			'A web application we built for a child development enrollment system, where I served as the Full-Stack Developer responsible for building the system across both front-end and back-end development.',
	...
	},
	{
		...
		title: 'Cat Club Cafe',
		description:
			'A web application we built for a cafe ordering system, where I served as the Full-Stack Developer responsible for building the system used to manage and process orders without a customer-facing user account.',
